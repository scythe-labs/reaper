...
# No offline ("--sql") mode: several heal migrations call ``op.get_bind()`` to inspect
# the live database, which an offline run has no connection for. Supporting "--sql" would
# mean removing those checks.
