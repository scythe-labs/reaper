...
- `clients/plex.py` — **21 methods repeat the same off-thread plus error-map wrapper**
  ...
  > **Landed at #673, as C14's option 5.** Every count in the row is wrong and C14's measurement
