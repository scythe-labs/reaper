...
| 7 | Wire contract | in progress | 7 of 8 | C7 and C11 both settled. Eight items, not ~5: W8-3 measures 20 unread fields and W8-4's anonymous payloads are 11 routes over 4 shapes. Only W8-1 is left |
...
| C4, C5, C8, C9, C10, C14 | not started | — |
