...
from reaper.engine import policy
...
async def _authorable_media(
    ...
    Policy picker offers it on (``policy.authorable_media_scope``, #549).
    ...
    try:
        ...
        libraries = []
    library_types = policy.library_media_types(libraries)
    try:
