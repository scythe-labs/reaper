...
class PolicyBody(Frozen):
    ...
    #: ``api.routes._season_replay``, which is what lets the panel name the one control at
    ...
    def evidence_hash(self) -> str:
        ...
        bundle is present or complete. ``api.routes._season_replay`` asks the evidence that
        second question, because a hash cannot answer it: two policies that gather identically
        still differ over a snapshot taken before the table existed.
