...
146 numbered blockers, distilled and adversarially verified across seven review passes. **The
...
to the scoped file that governs them and continue from 147.
...
| `.claude/rules/tests.md` | `tests/**/*.py`, `frontend/src/**/*.test.ts{,x}`, `frontend/src/test/**` — test discipline | 37, 118–119, 132–133, 135–137, 141, 145 |
