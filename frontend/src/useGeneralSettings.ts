 ...
 *  to ask. But the server cannot detect a language on its own, and the first authenticated read
 *  is the earliest moment a browser that CAN is talking to it -- `AuthGuard` opens only
 ...
 *  would show one language while a notification was written in another, which is the split this
