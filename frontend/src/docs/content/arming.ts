...
export const arming: Doc = {
  ...
  body: [
    p(
      "Editing a policy changes nothing about whether Reaper can delete. A fresh install is read-only: it can scan, score, and explain, and nothing else. Turning deletion on is its own act, and only you can do it.",
    ),
    callout(
      "note",
    ...
    ol([
      ...
      "Set your pace and grace, and turn on the Leaving Soon shelf so your household gets a warning.",
