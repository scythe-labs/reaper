            ...
            outcomes: [
              {
                ...
                detail: "deleted",
                detail_key: null,
                checks: [{ label: "Nobody was watching it right now", label_key: null, ok: true }],
                is_canary: false,
              },
            ],
          }),
        ...
        outcomes: [
          {
            ...
            detail_key: null,
            checks: [
              { label: "Nobody was watching it right now", label_key: null, ok: true },
              { label: "It was played since you approved it", label_key: null, ok: false },
            ],
            is_canary: false,
          },
        ],
