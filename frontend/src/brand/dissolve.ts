...
/** The fixed figure color -- a warm off-white, not pure white, so it sits with the ink. */
export const DISSOLVE_BONE = "#EDE7DA";
...
/** Blocks painted over the cut band, before the face cavity. */
