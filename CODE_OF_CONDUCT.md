...
maintainer, [@samwiseg0](https://github.com/samwiseg0).

If you would rather the report was not visible anywhere public, use the
[private reporting form](https://github.com/scythe-labs/reaper/security/advisories/new).
It is labeled for security reports and it is the private channel this project has, so
conduct reports sent there are read the same way and held in the same confidence.
